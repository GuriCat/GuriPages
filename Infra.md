...
#### ●インフラ収集情報
移行や構築時にIBM i から収集可能な主要情報の一覧。プロジェクトの要件やアクセス制限によって選別。IBM i 7.1以降の場合は[IBM i サービス(SQL)](https://www.ibm.com/docs/ja/i/7.6?topic=optimization-i-services){:target="_blank"}でPTF情報やTCP/IP設定の取得を推奨。
...
* [PSP - IBM i Group PTFs with Level](https://www.ibm.com/support/pages/ibm-i-group-ptfs-level){:target="_blank"}
  * 各IBM i リリースでタイトルが「Technology Refresh」のPTF(例：R760ならSF99967、R750ならSF99957、R730ならSF99727)を見つけます。このPTFのレベルをWRKPTFGRPコマンドで表示すれば、そのPTFのレベル=TRレベルとなります。

|Rel|Base GA|TR1|TR2|TR3|TR4|TR5|TR6|TR7|TR8|TR9|TR10|TR11|TR12|TR13| 
|:-|:-|:-|:-|:-|:-|:-|:-|:-|:-|:-|:-|:-|:-|:-|
|[7.6](https://www.ibm.com/support/pages/ibm-i-hardware-technology-refresh-information-ibm-i-76){:target="_blank"}|[25/04/18](https://www.ibm.com/support/pages/ibm-i-76-base-enhancements){:target="_blank"}|[25/11/21](https://www.ibm.com/support/pages/ibm-i-76-tr1-enhancements){:target="_blank"}|[26/07/24](https://www.ibm.com/support/pages/ibm-i-76-tr2-enhancements){:target="_blank"}|
|[7.5](https://www.ibm.com/support/pages/node/6597663){:target="_blank"}|[22/05/10](https://www.ibm.com/support/pages/ibm-i-75-base-enhancements){:target="_blank"}|[22/12/02](https://www.ibm.com/support/pages/ibm-i-75-tr1-enhancements){:target="_blank"}|[23/05/05](https://www.ibm.com/support/pages/ibm-i-75-tr2-enhancements){:target="_blank"}|[23/10/10](https://www.ibm.com/support/pages/ibm-i-75-tr3-enhancements){:target="_blank"}|[24/05/07](https://www.ibm.com/support/pages/ibm-i-75-tr4-enhancements){:target="_blank"}|[24/11/22](https://www.ibm.com/support/pages/ibm-i-75-tr5-enhancements){:target="_blank"}|[25/04/18](https://www.ibm.com/support/pages/ibm-i-75-tr6-enhancements){:target="_blank"}|[25/11/21](https://www.ibm.com/support/pages/ibm-i-75-tr7-enhancements){:target="_blank"}|[26/07/24](https://www.ibm.com/support/pages/ibm-i-75-tr8-enhancements){:target="_blank"}|
|[7.4](https://www.ibm.com/support/pages/node/959455){:target="_blank"}|[19/06/21](https://www.ibm.com/support/pages/node/1164634){:target="_blank"}|[19/11/15](https://www.ibm.com/support/pages/node/1164034){:target="_blank"}|[20/07/17](https://www.ibm.com/support/pages/node/1381917){:target="_blank"}|[20/11/13](https://www.ibm.com/support/pages/node/6250855){:target="_blank"}|[21/04/16](https://www.ibm.com/support/pages/node/6405632)|[21/09/10](https://www.ibm.com/support/pages/node/6456987){:target="_blank"}|[22/05/24](https://www.ibm.com/support/pages/ibm-i-74-tr6-enhancements){:target="_blank"}|[22/12/02](https://www.ibm.com/support/pages/ibm-i-74-tr7-enhancements){:target="_blank"}|[23/05/05](https://www.ibm.com/support/pages/ibm-i-74-tr8-enhancements){:target="_blank"}|[23/10/10](https://www.ibm.com/support/pages/ibm-i-74-tr9-enhancements){:target="_blank"}|[24/05/07](https://www.ibm.com/support/pages/ibm-i-74-tr10-enhancements){:target="_blank"}|[24/11/22](https://www.ibm.com/support/pages/ibm-i-74-tr11-enhancements){:target="_blank"}|[25/07/25](https://www.ibm.com/support/pages/ibm-i-74-tr12-enhancements){:target="_blank"}|
|[7.3](https://www.ibm.com/support/pages/node/687365){:target="_blank"}|[16/04/15](https://www.ibm.com/support/pages/node/1169032){:target="_blank"}|[16/11/11](https://www.ibm.com/support/pages/node/1168750){:target="_blank"}|[17/03/17](https://www.ibm.com/support/pages/node/1168480){:target="_blank"}|[17/10/27](https://www.ibm.com/support/pages/node/1164682){:target="_blank"}|[18/03/16](https://www.ibm.com/support/pages/node/1168426){:target="_blank"}|[18/09/14](https://www.ibm.com/support/pages/node/1164652){:target="_blank"}|[19/05/10](https://www.ibm.com/support/pages/node/1164646){:target="_blank"}|[19/11/15](https://www.ibm.com/support/pages/node/1164640){:target="_blank"}|[20/07/17](https://www.ibm.com/support/pages/node/6155511){:target="_blank"}|[20/11/13](https://www.ibm.com/support/pages/node/6250925){:target="_blank"}|[21/04/16](https://www.ibm.com/support/pages/node/6405636){:target="_blank"}|[21/09/10](https://www.ibm.com/support/pages/node/6456989){:target="_blank"}|[22/05/24](https://www.ibm.com/support/pages/node/6984311){:target="_blank"}|[22/12/02](https://www.ibm.com/support/pages/node/6984321){:target="_blank"}|
...
2025年以降のTechnology Refreshは「ハードウェアTR」と「ソフトウェアTR」に分割されました。上記表の日付はソフトウェアTR(TR PTFグループ)の提供開始日です。ハードウェアTRの詳細は各リリースの「IBM i Hardware Technology Refresh - Information」([7.6](https://www.ibm.com/support/pages/ibm-i-hardware-technology-refresh-information-ibm-i-76){:target="_blank"}/[7.5](https://www.ibm.com/support/pages/ibm-i-hardware-technology-refresh-information-ibm-i-75){:target="_blank"}/[7.4](https://www.ibm.com/support/pages/ibm-i-hardware-technology-refresh-information-ibm-i-74){:target="_blank"})を参照ください。例えばPower11対応のハードウェアTR(7.5 TR6/7.4 TR12相当)はPower11の出荷開始と同じ25/07/25に提供されています(7.4 TR12はハードウェアTRのみ)。
...
* IBM i Technology Updates - by IBM i product or subject matter
  ...
  * [Backup Recovery and Media Services (BRMS)](https://ibm.biz/ibmi-brms){:target="_blank"}：2025年にBRMSの開発・情報提供がFortra社に移管され、リンク先はFortraのWikiになりました
...
* 昔の分厚い「Performance Capabilities Reference Manual」(PCRM)は廃止され、現在はCPWなど基本情報だけがPCRMとして配布されています。経緯は[「What Happened to the IBM i PCRM?」](https://dawnmayi.com/2015/09/28/what-happened-to-the-ibm-i-pcrm/){:target="_blank"}に書かれています。
  ...
  * [「IBM i 7.6 Performance Capabilities Reference July 2025」](https://www.ibm.com/downloads/documents/us-en/10c31775c6d4009c){:target="_blank"}：Power11モデルを含む最新版
  ...
  * [「IBM Power Performance Report Power7 to Power11 Oct 27, 2025」](https://www.ibm.com/downloads/documents/us-en/10c31775c5d40fed){:target="_blank"}：Power8～11モデルのCPW
