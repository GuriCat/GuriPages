...
独立した repository を用意するほどの大きさではないので、一式を [この blog 内のディレクトリー](https://github.com/GuriCat/GuriPages/tree/main/files/IBM_i_CVE_and_PTF){:target="_blank"} に置いておきます。興味のある方は README.md の詳細をご確認ください。
