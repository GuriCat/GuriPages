...
タイトルに「Server OS」とありますが、IBM i は「Power10」でLinux/AIXとまとめて扱われています。IBM i が他のOSと同じ信頼性であるか不明なので、**私は**資料としての価値はあまり感じません(IBM zプラットフォームであれば良さを訴求できるでしょう)。2022年版などが[Webで公開されている](https://itic-corp.com/itic-2022-global-server-reliability-results/){:target="_blank"}ので、どんな内容かを知りたい方はそちらをどうぞ。
